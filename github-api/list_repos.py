...
def list_repos(user_name):
    ...
    while url:
        response = requests.get(url, headers=HEADERS, params={'per_page': 100}) # per_page parameter introduces pagination
    ...
    # [repo["name"] for repo in repos] -> List comprehension
